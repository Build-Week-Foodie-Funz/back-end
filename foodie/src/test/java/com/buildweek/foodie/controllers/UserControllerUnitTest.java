...
public class UserControllerUnitTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        User u1 = new User("admin", "ILuvM4th!", "Philadelphia" , "https://files.slack.com/files-pri/T4JUEB3ME-FN9BMEWQJ/nopath.png", "test@test.com", admins);
        ...
        User u2 = new User("cinnamon", "1234567","Philadelphia", "https://files.slack.com/files-pri/T4JUEB3ME-FN9BMEWQJ/nopath.png", "test@test.com", datas);
        ...
        User u3 = new User("testingbarn", "ILuvM4th!", "Philadelphia" , "https://files.slack.com/files-pri/T4JUEB3ME-FN9BMEWQJ/nopath.png", "test@test.com", users);
        ...
        User u4 = new User("testingcat", "password", "Philadelphia" , "https://files.slack.com/files-pri/T4JUEB3ME-FN9BMEWQJ/nopath.png", "test@test.com", users);
        u4.setUserid(104);
        userList.add(u4);

        users = new ArrayList<>();
        users.add(new UserRoles(new User(), r2));
        User u5 = new User("testingdog", "password","Philadelphia", "https://files.slack.com/files-pri/T4JUEB3ME-FN9BMEWQJ/nopath.png", "test@test.com", users);
        u5.setUserid(105);
        userList.add(u5);
